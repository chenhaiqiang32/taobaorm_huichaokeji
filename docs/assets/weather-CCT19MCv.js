...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function pl(){return new Ze({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function ml(){return new Ze({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function fg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===dc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===_h?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(t="SHADOWMAP_TYPE_VSM"),t}function pg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Di:case Ui:t="ENVMAP_TYPE_CUBE";break;case Ss:t="ENVMAP_TYPE_CUBE_UV";break}return t}function mg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ui:t="ENVMAP_MODE_REFRACTION";break}return t}function gg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Fa:t="ENVMAP_BLENDING_MULTIPLY";break;case Gh:t="ENVMAP_BLENDING_MIX";break;case Wh:t="ENVMAP_BLENDING_ADD";break}return t}function _g(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function vg(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=fg(e),c=pg(e),h=mg(e),u=gg(e),d=_g(e),f=sg(e),g=ag(s),_=r.createProgram();let m,p,E=e.glslVersion?"#version "+e.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
       ...
       `),n.uniforms.cameraPosition={value:new b(0,200,0)},n.uniforms.top={value:yn(this,Li).max.y},n.uniforms.bottom={value:0},n.uniforms.time={value:0},n.uniforms.uColor={value:new mt(12105912)},e.uniforms=n.uniforms},e}createGeometry(){const e=yn(this,Li),n=new ce,r=[],s=[],o=[],a=[];for(let l=0;l<yn(this,Jn).count;l++){const c=new b;c.x=Math.random()*(e.max.x-e.min.x)+e.min.x,c.y=Math.random()*(e.max.y-e.min.y)+e.min.y,c.z=Math.random()*(e.max.z-e.min.z)+e.min.z;const h=yn(this,Jn).size*(e.max.y-e.min.y)/80,u=h/80;r.push(c.x+u,c.y+h,c.z,c.x-u,c.y+h,c.z,c.x-u,c.y,c.z,c.x+u,c.y,c.z),s.push(c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z),o.push(1,1,0,1,0,0,1,0),a.push(l*4+0,l*4+1,l*4+2,l*4+0,l*4+2,l*4+3)}return n.setAttribute("position",new fe(new Float32Array(r),3)),n.setAttribute("normal",new fe(new Float32Array(s),3)),n.setAttribute("uv",new fe(new Float32Array(o),2)),n.setIndex(new fe(new Uint32Array(a),1)),n}dispose(){this.geometry.dispose(),this.material.dispose()}update(e,n){Xi(this,Kn,(yn(this,Kn)+e*yn(this,Jn).speed)%1),this.material&&"uniforms"in this.material&&(this.material.uniforms.cameraPosition.value=n,this.material.uniforms.time.value=yn(this,Kn))}}Kn=new WeakMap,Jn=new WeakMap,Li=new WeakMap;class Y_ extends Wc{constructor(e,n){super();Wi(this,"config");Wi(this,"box");Wi(this,"positionBackup",[]);this.config=n,this.box=e,this.geometry=this.createGeometry(),this.material=this.createMaterial(),this.renderOrder=10}createMaterial(){const e=new Gc({size:this.config.size,blending:ss,transparent:!0,depthWrite:!1});return e.onBeforeCompile=n=>{n.uniforms.uColor={value:new mt(16777215)},n.fragmentShader=n.fragmentShader.replace("#include <common>",`
         ...
         `)},e}createGeometry(){const e=this.box,n=this.config.count,r=new ce;let s=new Float32Array(n*3);for(let o=0;o<n*3;o+=3)s[o]=Math.random()*(e.max.x-e.min.x)+e.min.x,s[o+1]=Math.random()*(e.max.y-e.min.y)+e.min.y,s[o+2]=Math.random()*(e.max.z-e.min.z)+e.min.z,this.positionBackup.push(s[o],s[o+1],s[o+2]);return r.setAttribute("position",new le(s,3)),r}dispose(){this.geometry.dispose(),this.material.dispose()}update(){if(this.geometry){const e=this.geometry.getAttribute("position").array;for(let n=0;n<e.length;n+=3)e[n+1]-=this.config.speed,e[n+1]<this.box.min.y&&(e[n+1]=this.box.max.y,e[n]=this.positionBackup[n],e[n+2]=this.positionBackup[n+2]),e[n+2]+=Math.sin(n)*Math.random()*.1,e[n]-=Math.cos(n)*Math.random()*.1;this.geometry.getAttribute("position").needsUpdate=!0}}}class dv{constructor(t,e,n){const r=t.max.x-t.min.x,s=t.max.z-t.min.z,o=new ti(r,s,e,n),a=new Za().load("./textures/water_normal.jpg");a.wrapS=a.wrapT=ls;const l={textureWidth:512,textureHeight:512,waterNormals:a,sunDirection:new b,sunColor:16777215,waterColor:7695,distortionScale:.6,size:2};this.mesh=new W_(o,l),this.mesh.rotation.x=-Math.PI/2;const c=new b;t.getCenter(c),c.y=(t.max.y+t.min.y)/2,this.mesh.position.copy(c)}update(){this.mesh.material.uniforms.time.value+=1/180}}class fv extends Se{constructor(t,e){super();const r=new Za().load("/textures/bg.png");this.position.set(t.x,e.y-20,t.z),this.geometry=new ti(2e3,2e3),this.geometry.rotateX(-Math.PI/2),this.material=new qc({side:He,transparent:!0,opacity:.6,color:new mt("#7b8593"),map:r,metalness:.1,roughness:.8})}update(t){}}class pv extends Se{constructor(t=ZeroVec3,e=1,n=1){super(),this.position.copy(t),this.geometry=new ti(e,e,10,10),this.geometry.applyMatrix4(new Et().makeRotationX(-Math.PI/2)),this.material=new Ze({transparent:!0,depthTest:!1,side:He,uniforms:{uLevel:{value:n}},vertexShader:`
            ...
            `})}update(){this.rotation.z+=2e-4}}const Qc=4,Z_=8,$_=16,K_={value:Qc},th={value:0},rs={value:-100},eh={value:new Mt(100,-100)},me="//#shader_end#",ge="//#shader_uniform#",oc="//#diffuse_end#";nt.effect_uniform_fresnel=`
