...
#define LOW_PRECISION`),t}function dg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===uc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===gh?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(t="SHADOWMAP_TYPE_VSM"),t}function fg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Di:case Ui:t="ENVMAP_TYPE_CUBE";break;case Ss:t="ENVMAP_TYPE_CUBE_UV";break}return t}function pg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ui:t="ENVMAP_MODE_REFRACTION";break}return t}function mg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Fa:t="ENVMAP_BLENDING_MULTIPLY";break;case Hh:t="ENVMAP_BLENDING_MIX";break;case Gh:t="ENVMAP_BLENDING_ADD";break}return t}function gg(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function _g(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=dg(e),c=fg(e),h=pg(e),u=mg(e),d=gg(e),f=rg(e),g=sg(s),_=r.createProgram();let m,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
       ...
       `),n.uniforms.cameraPosition={value:new b(0,200,0)},n.uniforms.top={value:yn(this,Ii).max.y},n.uniforms.bottom={value:0},n.uniforms.time={value:0},n.uniforms.uColor={value:new mt(12105912)},e.uniforms=n.uniforms},e}createGeometry(){const e=yn(this,Ii),n=new ce,r=[],s=[],a=[],o=[];for(let l=0;l<yn(this,Jn).count;l++){const c=new b;c.x=Math.random()*(e.max.x-e.min.x)+e.min.x,c.y=Math.random()*(e.max.y-e.min.y)+e.min.y,c.z=Math.random()*(e.max.z-e.min.z)+e.min.z;const h=yn(this,Jn).size*(e.max.y-e.min.y)/80,u=h/80;r.push(c.x+u,c.y+h,c.z,c.x-u,c.y+h,c.z,c.x-u,c.y,c.z,c.x+u,c.y,c.z),s.push(c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z,c.x,c.y-h/2,c.z),a.push(1,1,0,1,0,0,1,0),o.push(l*4+0,l*4+1,l*4+2,l*4+0,l*4+2,l*4+3)}return n.setAttribute("position",new fe(new Float32Array(r),3)),n.setAttribute("normal",new fe(new Float32Array(s),3)),n.setAttribute("uv",new fe(new Float32Array(a),2)),n.setIndex(new fe(new Uint32Array(o),1)),n}dispose(){this.geometry.dispose(),this.material.dispose()}update(e,n){Xi(this,Kn,(yn(this,Kn)+e*yn(this,Jn).speed)%1),this.material&&"uniforms"in this.material&&(this.material.uniforms.cameraPosition.value=n,this.material.uniforms.time.value=yn(this,Kn))}}Kn=new WeakMap,Jn=new WeakMap,Ii=new WeakMap;class Y_ extends Gc{constructor(e,n){super();Wi(this,"config");Wi(this,"box");Wi(this,"positionBackup",[]);this.config=n,this.box=e,this.geometry=this.createGeometry(),this.material=this.createMaterial(),this.renderOrder=10}createMaterial(){const e=new Hc({size:this.config.size,blending:ss,transparent:!0,depthWrite:!1});return e.onBeforeCompile=n=>{n.uniforms.uColor={value:new mt(16777215)},n.fragmentShader=n.fragmentShader.replace("#include <common>",`
         ...
         `)},e}createGeometry(){const e=this.box,n=this.config.count,r=new ce;let s=new Float32Array(n*3);for(let a=0;a<n*3;a+=3)s[a]=Math.random()*(e.max.x-e.min.x)+e.min.x,s[a+1]=Math.random()*(e.max.y-e.min.y)+e.min.y,s[a+2]=Math.random()*(e.max.z-e.min.z)+e.min.z,this.positionBackup.push(s[a],s[a+1],s[a+2]);return r.setAttribute("position",new le(s,3)),r}dispose(){this.geometry.dispose(),this.material.dispose()}update(){if(this.geometry){const e=this.geometry.getAttribute("position").array;for(let n=0;n<e.length;n+=3)e[n+1]-=this.config.speed,e[n+1]<this.box.min.y&&(e[n+1]=this.box.max.y,e[n]=this.positionBackup[n],e[n+2]=this.positionBackup[n+2]),e[n+2]+=Math.sin(n)*Math.random()*.1,e[n]-=Math.cos(n)*Math.random()*.1;this.geometry.getAttribute("position").needsUpdate=!0}}}class dv{constructor(t,e,n){const r=t.max.x-t.min.x,s=t.max.z-t.min.z,a=new ti(r,s,e,n),o=new jc().load("./textures/water_normal.jpg");o.wrapS=o.wrapT=ls;const l={textureWidth:512,textureHeight:512,waterNormals:o,sunDirection:new b,sunColor:16777215,waterColor:7695,distortionScale:.6,size:2};this.mesh=new W_(a,l),this.mesh.rotation.x=-Math.PI/2;const c=new b;t.getCenter(c),c.y=(t.max.y+t.min.y)/2,this.mesh.position.copy(c)}update(){this.mesh.material.uniforms.time.value+=1/180}}class fv extends Se{constructor(t,e,n=null){super();let r,s;if(n){const a=new b;n.getSize(a);const o=Math.max(a.x,a.z)*.2;r=a.x+o,s=a.z+o}else r=100,s=100;this.position.set(t.x,e.y-.2,t.z),this.geometry=new ti(r,s),this.geometry.rotateX(-Math.PI/2),this.material=new Be({side:Ge,transparent:!0,uniforms:{uTime:{value:0},uResolution:{value:new vt(r,s)},uFrame:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `})}update(t){this.material&&this.material.uniforms&&(this.material.uniforms.uTime.value=t.elapsedTime,this.material.uniforms.uFrame.value=Math.floor(t.elapsedTime*60))}}class pv extends Se{constructor(t=ZeroVec3,e=1,n=1){super(),this.position.copy(t),this.geometry=new ti(e,e,10,10),this.geometry.applyMatrix4(new Et().makeRotationX(-Math.PI/2)),this.material=new Be({transparent:!0,depthTest:!1,side:Ge,uniforms:{uLevel:{value:n}},vertexShader:`
            ...
            `}),this.renderOrder=10}}function ya(i,t){return Math.random()*(t-i)+i}class j_ extends Gc{constructor(t,e){super();const{x:n,y:r,z:s}=e.max.clone().sub(e.min);let a=(n+r+s)/9;const o=new Float32Array(t*3);for(let l=0;l<t;l++){const c=ya(-n/2,n/2),h=ya(-r/2,r/2),u=ya(-s/2,s/2);new b(c,h,u).length()<a?(o[l*3]=c>0?c+a:c-a,o[l*3+1]=h>0?h+a:h-a,o[l*3+2]=u>0?u+a:u-a):(o[l*3]=c,o[l*3+1]=h,o[l*3+2]=u)}this.geometry.setAttribute("position",new fe(o,3)),this.material=new Be({transparent:!0,depthWrite:!1,blending:ss,vertexColors:!0,uniforms:{uSize:{value:230},uColor:{value:new mt("#F1FDFF")}},vertexShader:`
            uniform float uSize;
            ...
            `})}update(){this.rotation.z+=2e-4}}const Jc=4,Z_=8,$_=16,K_={value:Jc},Qc={value:0},rs={value:-100},th={value:new vt(100,-100)},me="//#shader_end#",ge="//#shader_uniform#",ac="//#diffuse_end#";nt.effect_uniform_fresnel=`
...
`;nt.custom_pars_vertex=p0;nt.custom_vertex=m0;nt.custom_pars_fragment=g0;nt.custom_fragment=_0;nt.weather_pars_fragment=v0;function mv(i,t="",e={}){i.uniforms.uElapseTime=Qc,Reflect.ownKeys(e).forEach(n=>{typeof e[n]=="object"&&e[n]!==null?(i.uniforms[n]=e[n],(e[n]instanceof mt||e[n]instanceof vt||e[n]instanceof b)&&(i.uniforms[n]={value:e[n]})):i.uniforms[n]={value:e[n]}}),y0(i),x0(i,t)}function x0(i,t){const e=f0[t];if(!e)return;const{chunk:n,uniform:r,vertex_chunk:s,vertex_uniform:a}=e;r&&ns(i,r.location,r.shader),a&&oc(i,a.location,a.shader),n&&(Array.isArray(n)?n.forEach(o=>{ns(i,o.location,o.shader)}):ns(i,n.location,n.shader)),s&&(Array.isArray(s)?s.forEach(o=>{ns(i,o.location,o.shader)}):oc(i,s.location,s.shader))}function y0(i){i.vertexShader.includes("#include <custom_pars_vertex>")||(i.vertexShader=i.vertexShader.replace("#include <common>",`
      #include <common>
