...
ShaderChunk.effect_uniform_sci_colorModify = /* glsl */ `

uniform vec3 uColor;
`;

ShaderChunk.effect_fragment_sci_colorModify = /* glsl */ `
...
// 导出结果
export const sci_colorModify = {
  uniform: { // uniform部分
    shader: "effect_uniform_sci_colorModify",
    location: SHADER_UNIFORM // 插入代码块的锚点 此处表示在uniform内插入，默认在#<common>后面插入
  },
  chunk: { // main函数部分 chunk可以是数组
    shader: "effect_fragment_sci_colorModify",
